...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/resources/icono_editor.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/resources/nuevo.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionNuevo_Escenario->setIcon(icon1);
        actionAbrir_Escenario = new QAction(MainWindow);
        actionAbrir_Escenario->setObjectName(QStringLiteral("actionAbrir_Escenario"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/resources/abrir.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionAbrir_Escenario->setIcon(icon2);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/resources/guardar.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionGuardar_Escenario->setIcon(icon3);
        actionBloque_de_Roca = new QAction(MainWindow);
        actionBloque_de_Roca->setObjectName(QStringLiteral("actionBloque_de_Roca"));
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/resources/bloqueRoca.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionBloque_de_Roca->setIcon(icon4);
        actionBloque_de_Metal = new QAction(MainWindow);
        actionBloque_de_Metal->setObjectName(QStringLiteral("actionBloque_de_Metal"));
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/resources/bloqueMetal.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionBloque_de_Metal->setIcon(icon5);
        ...
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/resources/bloquesMetalDiagonal.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionBloque_de_Metal_en_Diagonal->setIcon(icon6);
        actionAcido = new QAction(MainWindow);
        actionAcido->setObjectName(QStringLiteral("actionAcido"));
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/resources/acido2.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionAcido->setIcon(icon7);
        actionBoton = new QAction(MainWindow);
        actionBoton->setObjectName(QStringLiteral("actionBoton"));
        QIcon icon8;
        icon8.addFile(QStringLiteral(":/resources/boton.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionBoton->setIcon(icon8);
        actionRoca = new QAction(MainWindow);
        actionRoca->setObjectName(QStringLiteral("actionRoca"));
        QIcon icon9;
        icon9.addFile(QStringLiteral(":/resources/roca1.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionRoca->setIcon(icon9);
        ...
        QIcon icon10;
        icon10.addFile(QStringLiteral(":/resources/emisorEnergia.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionEmisor_de_Energia->setIcon(icon10);
        ...
        QIcon icon11;
        icon11.addFile(QStringLiteral(":/resources/receptorEnergia.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionReceptor_de_Energia->setIcon(icon11);
        actionPersonaje = new QAction(MainWindow);
        actionPersonaje->setObjectName(QStringLiteral("actionPersonaje"));
        QIcon icon12;
        icon12.addFile(QStringLiteral(":/resources/shell.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionPersonaje->setIcon(icon12);
        actionFondo = new QAction(MainWindow);
        actionFondo->setObjectName(QStringLiteral("actionFondo"));
        QIcon icon13;
        icon13.addFile(QStringLiteral(":/resources/fond.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionFondo->setIcon(icon13);
        actionBloqueOriginal = new QAction(MainWindow);
        actionBloqueOriginal->setObjectName(QStringLiteral("actionBloqueOriginal"));
        QIcon icon14;
        icon14.addFile(QStringLiteral(":/resources/bloquesMetalDiagonal0.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionBloqueOriginal->setIcon(icon14);
        actionBloqueRotado_90 = new QAction(MainWindow);
        actionBloqueRotado_90->setObjectName(QStringLiteral("actionBloqueRotado_90"));
        QIcon icon15;
        icon15.addFile(QStringLiteral(":/resources/bloquesMetalDiagonal90.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionBloqueRotado_90->setIcon(icon15);
        actionBloqueRotado_180 = new QAction(MainWindow);
        actionBloqueRotado_180->setObjectName(QStringLiteral("actionBloqueRotado_180"));
        QIcon icon16;
        icon16.addFile(QStringLiteral(":/resources/bloquesMetalDiagonal180.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionBloqueRotado_180->setIcon(icon16);
        actionBloqueRotado_270 = new QAction(MainWindow);
        actionBloqueRotado_270->setObjectName(QStringLiteral("actionBloqueRotado_270"));
        QIcon icon17;
        icon17.addFile(QStringLiteral(":/resources/bloquesMetalDiagonal270.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionBloqueRotado_270->setIcon(icon17);
        actionEmisorOriginal = new QAction(MainWindow);
        actionEmisorOriginal->setObjectName(QStringLiteral("actionEmisorOriginal"));
        QIcon icon18;
        icon18.addFile(QStringLiteral(":/resources/emisorEnergia0.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionEmisorOriginal->setIcon(icon18);
        actionEmisor_Rotado_90 = new QAction(MainWindow);
        actionEmisor_Rotado_90->setObjectName(QStringLiteral("actionEmisor_Rotado_90"));
        QIcon icon19;
        icon19.addFile(QStringLiteral(":/resources/emisorEnergia90.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionEmisor_Rotado_90->setIcon(icon19);
        ...
        QIcon icon20;
        icon20.addFile(QStringLiteral(":/resources/emisorEnergia180.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionEmisor_Rotado_180->setIcon(icon20);
        ...
        QIcon icon21;
        icon21.addFile(QStringLiteral(":/resources/emisorEnergia270.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionEmisor_Rotado_270->setIcon(icon21);
        ...
        QIcon icon22;
        icon22.addFile(QStringLiteral(":/resources/receptorEnergia0.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionReceptor_Original->setIcon(icon22);
        ...
        QIcon icon23;
        icon23.addFile(QStringLiteral(":/resources/receptorEnergia180.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionReceptor_Rotado_180->setIcon(icon23);
        ...
        QIcon icon24;
        icon24.addFile(QStringLiteral(":/resources/receptorEnergia270.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionReceptor_Rotado_270->setIcon(icon24);
        ...
        QIcon icon25;
        icon25.addFile(QStringLiteral(":/resources/compuerta1.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionCompuerta_Regular->setIcon(icon25);
        actionCompuerta_AND = new QAction(MainWindow);
        actionCompuerta_AND->setObjectName(QStringLiteral("actionCompuerta_AND"));
        QIcon icon26;
        icon26.addFile(QStringLiteral(":/resources/compuerta2.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionCompuerta_AND->setIcon(icon26);
        actionCompuerta_OR = new QAction(MainWindow);
        actionCompuerta_OR->setObjectName(QStringLiteral("actionCompuerta_OR"));
        QIcon icon27;
        icon27.addFile(QStringLiteral(":/resources/compuerta3.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionCompuerta_OR->setIcon(icon27);
        ...
        QIcon icon28;
        icon28.addFile(QStringLiteral(":/resources/barreraDeEnergiaHorizontal.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionBarrera_Horizontal->setIcon(icon28);
        actionBarrera_Vertical = new QAction(MainWindow);
        actionBarrera_Vertical->setObjectName(QStringLiteral("actionBarrera_Vertical"));
        QIcon icon29;
        icon29.addFile(QStringLiteral(":/resources/barreraDeEnergiaVertical.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionBarrera_Vertical->setIcon(icon29);
        ...
        QIcon icon30;
        icon30.addFile(QStringLiteral(":/resources/receptorEnergia90.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionReceptor_Rotado_90->setIcon(icon30);
        actionPastel = new QAction(MainWindow);
        actionPastel->setObjectName(QStringLiteral("actionPastel"));
        QIcon icon31;
        icon31.addFile(QStringLiteral(":/resources/cake.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionPastel->setIcon(icon31);
        ...
        QIcon icon32;
        icon32.addFile(QStringLiteral(":/resources/configuracionCompuertas.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionConfiguracion_de_Compuertas->setIcon(icon32);
        ...
        actionConfiguracion_de_Personajes->setIcon(icon32);
        ...
        mainToolBar->addAction(actionAcido);
